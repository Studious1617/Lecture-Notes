...
public class HelloWriting {
    public static void main(String[] args) throws IOException {
        ...
        try (FileWriter writer = new FileWriter("hello.txt"); BufferedWriter bufferedWriter = new BufferedWriter(writer)) {
            ...
            System.out.println("Error writing to " + e + " file.");
        }

        try (FileWriter writer2 = new FileWriter("hello.txt", true);
             BufferedWriter bufferedWriter2 = new BufferedWriter(writer2)) {  //Append flag - true means add data to the end of the file
            ...
            System.out.println("Error appending data to " + e + " file.");
        }
    }
}
