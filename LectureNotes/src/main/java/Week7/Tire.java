...
public class Tire implements Comparable<Tire> {
    ...
    public int compareTo(Tire anotherTire){
        //return Double.compare(this.pricePer1000Miles(), anotherTire.pricePer1000Miles());  //<-- One way to do it
        return this.name.compareTo(anotherTire.name);  //<-- Another way to do it
    }
}
